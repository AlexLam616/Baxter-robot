...
if("FALSE" STREQUAL "TRUE")
  set(lidar_alarm_SOURCE_PREFIX /home/alex/workspace/src/learning_ros_noetic/Part_2/lidar_alarm)
  set(lidar_alarm_DEVEL_PREFIX /home/alex/workspace/devel)
  ...
  set(lidar_alarm_INSTALL_PREFIX /home/alex/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_alarm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lidar_alarm_NUM_DUMMY_TARGETS)
      set(lidar_alarm_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lidar_alarm::wrapped-linker-option${lidar_alarm_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lidar_alarm_NUM_DUMMY_TARGETS "${lidar_alarm_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lidar_alarm::wrapped-linker-option${lidar_alarm_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lidar_alarm_LIBRARIES "${interface_target_name}")
