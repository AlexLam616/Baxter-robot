...
if("FALSE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /home/alex/workspace/src/learning_ros_noetic/Part_6/coordinator)
  set(coordinator_DEVEL_PREFIX /home/alex/workspace/devel)
  ...
  set(coordinator_INSTALL_PREFIX /home/alex/workspace/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
