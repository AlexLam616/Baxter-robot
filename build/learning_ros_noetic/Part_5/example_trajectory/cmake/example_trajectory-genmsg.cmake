...
add_custom_target(_example_trajectory_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example_trajectory" "/home/alex/workspace/devel/share/example_trajectory/msg/TrajActionResult.msg" ""
)

get_filename_component(_filename "/home/alex/workspace/devel/share/example_trajectory/msg/TrajActionFeedback.msg" NAME_WE)
add_custom_target(_example_trajectory_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example_trajectory" "/home/alex/workspace/devel/share/example_trajectory/msg/TrajActionFeedback.msg" ""
)
