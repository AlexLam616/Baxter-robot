...
add_custom_target(_baxter_trajectory_streamer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "baxter_trajectory_streamer" "/home/alex/workspace/devel/share/baxter_trajectory_streamer/msg/trajResult.msg" ""
)

get_filename_component(_filename "/home/alex/workspace/devel/share/baxter_trajectory_streamer/msg/trajFeedback.msg" NAME_WE)
add_custom_target(_baxter_trajectory_streamer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "baxter_trajectory_streamer" "/home/alex/workspace/devel/share/baxter_trajectory_streamer/msg/trajFeedback.msg" ""
)
