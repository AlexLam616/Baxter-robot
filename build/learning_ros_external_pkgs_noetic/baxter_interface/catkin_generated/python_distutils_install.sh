...
echo_and_run cd "/home/alex/workspace/src/learning_ros_external_pkgs_noetic/baxter_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alex/workspace/src/learning_ros_external_pkgs_noetic/baxter_interface/setup.py" \
     \
    build --build-base "/home/alex/workspace/build/learning_ros_external_pkgs_noetic/baxter_interface" \
    install \
    --root="${DESTDIR-/}" \
