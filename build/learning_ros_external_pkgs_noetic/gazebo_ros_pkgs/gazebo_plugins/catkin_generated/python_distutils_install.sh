...
echo_and_run cd "/home/alex/workspace/src/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alex/workspace/src/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/alex/workspace/build/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
