...
"""autogenerated by genpy from arm_motion_action/arm_interfaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class arm_interfaceActionResult(genpy.Message):
  _md5sum = "fb47a526b3088a7f50fa37cd5c1fd659"
  _type = "arm_motion_action/arm_interfaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm_motion_action/arm_interfaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arm_interfaceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = arm_motion_action.msg.arm_interfaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arm_motion_action.msg.arm_interfaceResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3i().pack(_x.result.return_code, _x.result.err_code, _x.result.num_path_segs))
      length = len(self.result.segmented_path_arrival_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.result.segmented_path_arrival_times))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.return_code, _x.result.err_code, _x.result.num_path_segs,) = _get_struct_3i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.result.segmented_path_arrival_times = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.result.segmented_path_arrival_times.tostring())
      _x = self.result.err_msg
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.result.segmented_path_arrival_times = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
