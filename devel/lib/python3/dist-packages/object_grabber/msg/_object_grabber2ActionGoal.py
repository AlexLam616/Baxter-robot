...
"""autogenerated by genpy from object_grabber/object_grabber2ActionGoal.msg. Do not edit."""
import codecs
import sys
...
class object_grabber2ActionGoal(genpy.Message):
  _md5sum = "964e154d9eb428c270cc0c06a5860d3d"
  _type = "object_grabber/object_grabber2ActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','object_grabber/object_grabber2Goal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_grabber2ActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = object_grabber.msg.object_grabber2Goal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = object_grabber.msg.object_grabber2Goal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2i3I().pack(_x.goal.action_code, _x.goal.object_id, _x.goal.desired_frame.header.seq, _x.goal.desired_frame.header.stamp.secs, _x.goal.desired_frame.header.stamp.nsecs))
      _x = self.goal.desired_frame.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.goal.desired_frame.pose.position.x, _x.goal.desired_frame.pose.position.y, _x.goal.desired_frame.pose.position.z, _x.goal.desired_frame.pose.orientation.x, _x.goal.desired_frame.pose.orientation.y, _x.goal.desired_frame.pose.orientation.z, _x.goal.desired_frame.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.action_code, _x.goal.object_id, _x.goal.desired_frame.header.seq, _x.goal.desired_frame.header.stamp.secs, _x.goal.desired_frame.header.stamp.nsecs,) = _get_struct_2i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
