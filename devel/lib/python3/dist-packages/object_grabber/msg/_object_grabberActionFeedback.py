...
"""autogenerated by genpy from object_grabber/object_grabberActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class object_grabberActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "object_grabber/object_grabberActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','object_grabber/object_grabberFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_grabberActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = object_grabber.msg.object_grabberFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = object_grabber.msg.object_grabberFeedback()
