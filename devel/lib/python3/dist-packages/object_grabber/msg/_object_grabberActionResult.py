...
"""autogenerated by genpy from object_grabber/object_grabberActionResult.msg. Do not edit."""
import codecs
import sys
...
class object_grabberActionResult(genpy.Message):
  _md5sum = "7601dfabb9ed9c7837af8d40f6a082ef"
  _type = "object_grabber/object_grabberActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','object_grabber/object_grabberResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_grabberActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = object_grabber.msg.object_grabberResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = object_grabber.msg.object_grabberResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_id().pack(_x.result.return_code, _x.result.computed_move_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.return_code, _x.result.computed_move_time,) = _get_struct_id().unpack(str[start:end])
      return self
