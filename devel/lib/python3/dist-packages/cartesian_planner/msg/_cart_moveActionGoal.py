...
class cart_moveActionGoal(genpy.Message):
  _md5sum = "f52ca9bcb6c1f35145603757888dc2bc"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_id().pack(_x.goal.command_code, _x.goal.time_scale_stretch_factor))
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.goal.des_pose_gripper.header.seq, _x.goal.des_pose_gripper.header.stamp.secs, _x.goal.des_pose_gripper.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.command_code, _x.goal.time_scale_stretch_factor,) = _get_struct_id().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.goal.des_pose_gripper.header.seq, _x.goal.des_pose_gripper.header.stamp.secs, _x.goal.des_pose_gripper.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
