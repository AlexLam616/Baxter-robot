...
class cart_moveGoal(genpy.Message):
  _md5sum = "4d8a761bd6c731c2de8d9011739b59be"
...
"""
  ...
  __slots__ = ['command_code','time_scale_stretch_factor','arm_dp','q_goal','des_pose_gripper']
  _slot_types = ['int32','float64','float64[]','float64[]','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command_code,time_scale_stretch_factor,arm_dp,q_goal,des_pose_gripper
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_id().pack(_x.command_code, _x.time_scale_stretch_factor))
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.des_pose_gripper.header.seq, _x.des_pose_gripper.header.stamp.secs, _x.des_pose_gripper.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.command_code, _x.time_scale_stretch_factor,) = _get_struct_id().unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.des_pose_gripper.header.seq, _x.des_pose_gripper.header.stamp.secs, _x.des_pose_gripper.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
