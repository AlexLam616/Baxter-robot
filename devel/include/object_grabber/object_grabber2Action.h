...
bool operator==(const ::object_grabber::object_grabber2Action_<ContainerAllocator1> & lhs, const ::object_grabber::object_grabber2Action_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::object_grabber::object_grabber2Action_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x020d8c1c2b6e1ffdULL;
  static const uint64_t static_value2 = 0x944819792cf3c1c3ULL;
};
