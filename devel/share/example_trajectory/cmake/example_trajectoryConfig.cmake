...
if("TRUE" STREQUAL "TRUE")
  set(example_trajectory_SOURCE_PREFIX /home/alex/workspace/src/learning_ros_noetic/Part_5/example_trajectory)
  set(example_trajectory_DEVEL_PREFIX /home/alex/workspace/devel)
  ...
  set(example_trajectory_INSTALL_PREFIX /home/alex/workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'example_trajectory' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'example_trajectory' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/workspace/src/learning_ros_noetic/Part_5/example_trajectory/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT example_trajectory_NUM_DUMMY_TARGETS)
      set(example_trajectory_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::example_trajectory::wrapped-linker-option${example_trajectory_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR example_trajectory_NUM_DUMMY_TARGETS "${example_trajectory_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::example_trajectory::wrapped-linker-option${example_trajectory_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND example_trajectory_LIBRARIES "${interface_target_name}")
...
set(example_trajectory_EXPORTED_TARGETS "example_trajectory_generate_messages_cpp;example_trajectory_generate_messages_eus;example_trajectory_generate_messages_lisp;example_trajectory_generate_messages_nodejs;example_trajectory_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${example_trajectory_dep}_FOUND)
      find_package(${example_trajectory_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${example_trajectory_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
