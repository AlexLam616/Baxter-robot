...
// (in-package baxter_trajectory_streamer.msg)
...
class trajActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = trajResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.result = trajResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.result !== undefined) {
      resolved.result = trajResult.Resolve(msg.result)
    }
    else {
      resolved.result = new trajResult()
    }
