...
class object_grabber2ActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new object_grabber2Result();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = object_grabber2Result.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_grabber2ActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = object_grabber2Result.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += object_grabber2Result.getMessageSize(object.result);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'object_grabber/object_grabber2ActionResult';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4a8ab9893af090a0b68f870fe70f8b9b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_grabber2ActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = object_grabber2Result.Resolve(msg.result)
    }
    else {
      resolved.result = new object_grabber2Result()
    }
...
module.exports = object_grabber2ActionResult;
