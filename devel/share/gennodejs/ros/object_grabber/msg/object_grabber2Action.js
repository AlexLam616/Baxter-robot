...
class object_grabber2Action {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new object_grabber2ActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new object_grabber2ActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new object_grabber2ActionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = object_grabber2ActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = object_grabber2ActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = object_grabber2ActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_grabber2Action(null);
    // Deserialize message field [action_goal]
    data.action_goal = object_grabber2ActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = object_grabber2ActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = object_grabber2ActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += object_grabber2ActionGoal.getMessageSize(object.action_goal);
    length += object_grabber2ActionResult.getMessageSize(object.action_result);
    length += object_grabber2ActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '020d8c1c2b6e1ffd944819792cf3c1c3';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_grabber2Action(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = object_grabber2ActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new object_grabber2ActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = object_grabber2ActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new object_grabber2ActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = object_grabber2ActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new object_grabber2ActionFeedback()
    }
...
module.exports = object_grabber2Action;
