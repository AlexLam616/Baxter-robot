...
let demoFeedback = require('./demoFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class demoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = demoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new demoActionFeedback(null);
    ...
    data.feedback = demoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new demoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = demoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new demoFeedback()
    }
...
module.exports = demoActionFeedback;
