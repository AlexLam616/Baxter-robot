...
class cart_moveActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new cart_moveResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = cart_moveResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cart_moveResult.getMessageSize(object.result);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '406a5be93ea35161d31df71ebd4f2678';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cart_moveActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = cart_moveResult.Resolve(msg.result)
    }
    else {
      resolved.result = new cart_moveResult()
    }
...
module.exports = cart_moveActionResult;
