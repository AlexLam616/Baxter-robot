...
class cart_moveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new cart_moveFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = cart_moveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cart_moveActionFeedback(null);
    ...
    data.feedback = cart_moveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cart_moveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = cart_moveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new cart_moveFeedback()
    }
...
module.exports = cart_moveActionFeedback;
