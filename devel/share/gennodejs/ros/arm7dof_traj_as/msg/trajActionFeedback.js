...
class trajActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new trajFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = trajFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new trajActionFeedback(null);
    ...
    data.feedback = trajFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'arm7dof_traj_as/trajActionFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new trajActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = trajFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new trajFeedback()
    }
...
module.exports = trajActionFeedback;
