...
let navigatorFeedback = require('./navigatorFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class navigatorActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new navigatorFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type navigatorActionFeedback
    ...
    bufferOffset = navigatorFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type navigatorActionFeedback
    let len;
    let data = new navigatorActionFeedback(null);
    ...
    data.feedback = navigatorFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'navigator/navigatorActionFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new navigatorActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = navigatorFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new navigatorFeedback()
    }
...
module.exports = navigatorActionFeedback;
