...
class arm_interfaceActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new arm_interfaceFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = arm_interfaceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new arm_interfaceActionFeedback(null);
    ...
    data.feedback = arm_interfaceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'arm_motion_action/arm_interfaceActionFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new arm_interfaceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = arm_interfaceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new arm_interfaceFeedback()
    }
...
module.exports = arm_interfaceActionFeedback;
