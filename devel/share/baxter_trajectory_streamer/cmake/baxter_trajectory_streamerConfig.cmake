...
if("TRUE" STREQUAL "TRUE")
  set(baxter_trajectory_streamer_SOURCE_PREFIX /home/alex/workspace/src/learning_ros_noetic/Part_5/baxter/baxter_trajectory_streamer)
  set(baxter_trajectory_streamer_DEVEL_PREFIX /home/alex/workspace/devel)
  ...
  set(baxter_trajectory_streamer_INSTALL_PREFIX /home/alex/workspace/install)
...
if(NOT "/home/alex/workspace/devel/include;/home/alex/workspace/src/learning_ros_noetic/Part_5/baxter/baxter_trajectory_streamer/include " STREQUAL " ")
  set(baxter_trajectory_streamer_INCLUDE_DIRS "")
  set(_include_dirs "/home/alex/workspace/devel/include;/home/alex/workspace/src/learning_ros_noetic/Part_5/baxter/baxter_trajectory_streamer/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_trajectory_streamer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_trajectory_streamer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/workspace/src/learning_ros_noetic/Part_5/baxter/baxter_trajectory_streamer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_trajectory_streamer_NUM_DUMMY_TARGETS)
      set(baxter_trajectory_streamer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_trajectory_streamer::wrapped-linker-option${baxter_trajectory_streamer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_trajectory_streamer_NUM_DUMMY_TARGETS "${baxter_trajectory_streamer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_trajectory_streamer::wrapped-linker-option${baxter_trajectory_streamer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_trajectory_streamer_LIBRARIES "${interface_target_name}")
...
set(baxter_trajectory_streamer_EXPORTED_TARGETS "baxter_trajectory_streamer_generate_messages_cpp;baxter_trajectory_streamer_generate_messages_eus;baxter_trajectory_streamer_generate_messages_lisp;baxter_trajectory_streamer_generate_messages_nodejs;baxter_trajectory_streamer_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${baxter_trajectory_streamer_dep}_FOUND)
      find_package(${baxter_trajectory_streamer_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_trajectory_streamer_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
